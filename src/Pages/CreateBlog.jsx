      ...
      <label  className="block mt-2 mb-2 text-lg bold font-semibold text-gray-600">
        ...
        <div className="mt-2">
          <textarea
            ...
            onChange={handleChange}
            value={formData.body}
            className="resize-none border-2 block w-full h-fixed rounded-md border-0 py-1.5 text-gray-900 shadow-sm  placeholder:text-gray-400 focus:ring-2  sm:text-sm sm:leading-6"
          />
        </div>
      </div>
