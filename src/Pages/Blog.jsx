    ...
    <div class="lg:row-start-1 lg:mx-auto  lg:w-full lg:max-w-7xl lg:gap-x-8 lg:px-8">
      <div class="lg:pr-4">
        <div class="">
          ...
          <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl uppercase">A better workflow</h1>
          <div class="sm:text-center flex gap-5 items-center">
            <a href="/" aria-label="Author" class=" mb-1">
            ...
            <p class="text-sm font-medium leading-4 text-gray-600">Laria Clarence</p>
