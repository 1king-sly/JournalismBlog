...
const Dashboard = () => {
  return (
    <>
    {/* statistics */}
      <div className=" mb-5 grid gap-10 col-span-3 items-center sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div className='  col-span-3 shadow-md bg-white    py-2.5 '>
        ...
        <div className='  col-span-3 shadow-md bg-white    py-2.5 '>
        <a href="">
        <ul className='grid hover:shadow-lg grid-cols-4 gap-10 shadow-md bg-white  border-solid ml-2 py-2.5 px-2'>
          <li > 
