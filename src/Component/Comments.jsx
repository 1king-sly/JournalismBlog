...
const Comments = ({category,image_id}) => {
    ...
    return (
        <div className=' px-10 '>
          <h1 className='mb-1 uppercase font-bold text-xl  my-5 '>LEAVE A COMMENT</h1>
            <label>
                {/* Comment: */}
                <textarea id='textarea' name='textarea' rows="4" cols="50" placeholder='Your Comment' className=' max-[475px]:w-11/12  resize-none border-2' value={content} onChange={(e) => setContent(e.target.value)} />
            </label>
            <br />
