...
function Content(props) {
 ...
 <div className="col-span-2 w-screen   object-contain">
    ...
    <div className=" ">
      ...
      className="w-11/12 max-w-[600px]  max-h-[600px] rounded-md bg-gray-900 object-cover shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] mb-10" src={image} alt="News image"/>
    </div>
